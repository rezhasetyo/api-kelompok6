...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">API Film</span>
      </a>
  ...
  <li class="nav-item">
    <a class="nav-link " href="/genre">
      <i class="bi bi-layout-text-window-reverse"></i>
      <span>Tabel Genre</span>
    </a>
  </li>
      
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>API</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="api/film">
              <i class="bi bi-circle"></i><span>API Film</span>
            </a>
          </li>
          <li>
            <a href="api/genre">
              <i class="bi bi-circle"></i><span>API Genre</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
